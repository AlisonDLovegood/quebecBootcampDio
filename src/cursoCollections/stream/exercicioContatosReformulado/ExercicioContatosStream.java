package cursoCollections.stream.exercicioContatosReformulado;

import java.util.*;
import java.util.function.Function;

public class ExercicioContatosStream {
