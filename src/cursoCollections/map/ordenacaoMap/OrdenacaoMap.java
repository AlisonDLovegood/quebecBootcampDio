package cursoCollections.map.ordenacaoMap;
...
public class OrdenacaoMap {
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------------------");
        System.out.println("Ordem aleatória exibindo separadamente apenas autor e livro:");
        ...
        System.out.println("------------------------------------------");
//        como os nomes dos livros estão no valor, e não na chave, preciso trabalhar com treeset pq precisa passar o comparator
